...
# Repeat all previous steps on remaining 2014Burro samples
```

#### Combine individual gVCF files using a ‘snowball’ strategy
...
# Repeat all previous steps on 2014Paredon samples
