...
ggsave(plot=gg.a, filename="cv.png", device=png, width=10, height=2, units="in", dpi=300)
ggsave(plot=gg.a, filename="cv.pdf", device=cairo_pdf, width=10, height=2, units="in")
