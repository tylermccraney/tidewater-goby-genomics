...
saveRDS(object=gene.windows, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/gene.windows.RDS")
write_tsv(gene.windows, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/gene.windows.tsv")

window.genes <- 
  select(gene.windows, seqid, window, gene_id)
  
saveRDS(object=window.genes, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/window.genes.RDS")
write_tsv(window.genes, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/window.genes.tsv")
...
saveRDS(object=dat, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Candidate.Genes.RDS")
write_tsv(dat, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Candidate.Genes.tsv")


filter(dat, pop1=="Del Norte-Humboldt", stat=="iHS") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_scores_NorteHumboldt", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat=="iHS") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_scores_Mendocino", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat=="iHS") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_scores_SantaBarbara", col_names=FALSE)

#
filter(dat, pop1=="Del Norte-Humboldt", stat=="nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_scores_NorteHumboldt", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat=="nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_scores_Mendocino", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat=="nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_scores_SantaBarbara", col_names=FALSE)
...
filter(dat, pop1=="Del Norte-Humboldt", pop2=="Mendocino", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_scores_NorteHumboldt_Mendocino", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Santa Barbara", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_scores_NorteHumboldt_SantaBarbara", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Del Norte-Humboldt", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_scores_Mendocino_NorteHumboldt", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Santa Barbara", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_scores_Mendocino_SantaBarbara", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Del Norte-Humboldt", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_scores_SantaBarbara_NorteHumboldt", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Mendocino", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_scores_SantaBarbara_Mendocino", col_names=FALSE)
...
filter(dat, pop1=="Del Norte-Humboldt", pop2=="Mendocino", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_scores_NorteHumboldt_Mendocino", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Santa Barbara", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_scores_NorteHumboldt_SantaBarbara", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Del Norte-Humboldt", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_scores_Mendocino_NorteHumboldt", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Santa Barbara", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_scores_Mendocino_SantaBarbara", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Del Norte-Humboldt", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_scores_SantaBarbara_NorteHumboldt", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Mendocino", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession, score) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_scores_SantaBarbara_Mendocino", col_names=FALSE)
...
filter(dat, pop1=="Del Norte-Humboldt", stat!="-XP-nSL", candidate==TRUE) |> 
  ...
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/combo_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", stat!="-XP-nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/combo_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat!="-XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/combo_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat!="-XP-nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/combo_Mendocino_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat!="-XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/combo_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat!="-XP-nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/combo_SantaBarbara_REF", col_names=FALSE)
...
filter(dat, pop1=="Del Norte-Humboldt", stat=="iHS", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", stat=="iHS") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat=="iHS", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat=="iHS") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_Mendocino_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat=="iHS", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat=="iHS") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/iHS_SantaBarbara_REF", col_names=FALSE)

#
filter(dat, pop1=="Del Norte-Humboldt", stat=="nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", stat=="nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat=="nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", stat=="nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_Mendocino_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat=="nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", stat=="nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/nSL_SantaBarbara_REF", col_names=FALSE)

#
filter(dat, pop1=="Del Norte-Humboldt", pop2=="Mendocino", stat=="XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_NorteHumboldt_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Mendocino", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_NorteHumboldt_Mendocino_REF", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Santa Barbara", stat=="XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_NorteHumboldt_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Santa Barbara", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_NorteHumboldt_SantaBarbara_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Del Norte-Humboldt", stat=="XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_Mendocino_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Del Norte-Humboldt", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_Mendocino_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Santa Barbara", stat=="XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_Mendocino_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Santa Barbara", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_Mendocino_SantaBarbara_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Del Norte-Humboldt", stat=="XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_SantaBarbara_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Del Norte-Humboldt", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_SantaBarbara_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Mendocino", stat=="XP-nSL", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_SantaBarbara_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Mendocino", stat=="XP-nSL") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-nSL_SantaBarbara_Mendocino_REF", col_names=FALSE)
...
filter(dat, pop1=="Del Norte-Humboldt", pop2=="Mendocino", stat=="XP-CLR", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_NorteHumboldt_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Mendocino", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_NorteHumboldt_Mendocino_REF", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Santa Barbara", stat=="XP-CLR", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_NorteHumboldt_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt", pop2=="Santa Barbara", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_NorteHumboldt_SantaBarbara_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Del Norte-Humboldt", stat=="XP-CLR", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_Mendocino_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Del Norte-Humboldt", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_Mendocino_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Santa Barbara", stat=="XP-CLR", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_Mendocino_SantaBarbara_TOP", col_names=FALSE)

filter(dat, pop1=="Mendocino", pop2=="Santa Barbara", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_Mendocino_SantaBarbara_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Del Norte-Humboldt", stat=="XP-CLR", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_SantaBarbara_NorteHumboldt_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Del Norte-Humboldt", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession) |>
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_SantaBarbara_NorteHumboldt_REF", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Mendocino", stat=="XP-CLR", candidate==TRUE) |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_SantaBarbara_Mendocino_TOP", col_names=FALSE)

filter(dat, pop1=="Santa Barbara", pop2=="Mendocino", stat=="XP-CLR") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/XP-CLR_SantaBarbara_Mendocino_REF", col_names=FALSE)
...
filter(top10, pop1=="Del Norte-Humboldt") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/NorteHumboldt_TOP10", col_names=FALSE)

filter(dat, pop1=="Del Norte-Humboldt") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/NorteHumboldt_REF", col_names=FALSE)

filter(top10, pop1=="Mendocino") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Mendocino_TOP10", col_names=FALSE)

filter(dat, pop1=="Mendocino") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Mendocino_REF", col_names=FALSE)

filter(top10, pop1=="Santa Barbara") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/SantaBarbara_TOP10", col_names=FALSE)

filter(dat, pop1=="Santa Barbara") |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/SantaBarbara_REF", col_names=FALSE)
...
gg.sets_iHS <- 
  ggvenn(
    ...
    stroke_alpha=1,
    auto_scale=FALSE) + 
  labs(title="454 Candidate Genes (iHS)", tag="(d)") + 
...
ggsave(plot=gg.sets_iHS, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.iHS.png", bg="white", device=png, width=5, height=5, units="in", dpi=320)
ggsave(plot=gg.sets_iHS, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.iHS.pdf", bg="white", device=cairo_pdf, width=5, height=5, units="in")
...
gg.sets_nSL <- 
  ggvenn(
    ...
    stroke_alpha=1,
    auto_scale=FALSE) + 
  labs(title="418 Candidate Genes (nSL)", tag="(d)") + 
  theme(plot.caption=element_text(size=13, hjust=0.5), plot.title=element_text(size=15, hjust=0.5), plot.tag=element_text(size=15))
gg.sets_nSL

ggsave(plot=gg.sets_nSL, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.nSL.png", bg="white", device=png, width=5, height=5, units="in", dpi=320)
ggsave(plot=gg.sets_nSL, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.nSL.pdf", bg="white", device=cairo_pdf, width=5, height=5, units="in")

saveRDS(object=gg.sets_nSL, file='/Users/macrodontogobius/Library/CloudStorage/GoogleDrive-wtm3@humboldt.edu/My Drive/tgoby/fig2/nSLd.RDS')
...
gg.sets_XPnSL <- 
  ggvenn(
    ...
    stroke_alpha=1,
    auto_scale=FALSE) + 
  labs(title="746 Candidate Genes (XP-nSL)", tag="(d)") + 
  theme(plot.caption=element_text(size=13, hjust=0.5), plot.title=element_text(size=15, hjust=0.5), plot.tag=element_text(size=15))
gg.sets_XPnSL

ggsave(plot=gg.sets_XPnSL, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.XPnSL.png", bg="white", device=png, width=5, height=5, units="in", dpi=320)
ggsave(plot=gg.sets_XPnSL, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.XPnSL.pdf", bg="white", device=cairo_pdf, width=5, height=5, units="in")


unique(c(`sets_-XPnSL`[[1]], `sets_-XPnSL`[[2]], `sets_-XPnSL`[[3]])) |> length()
...
`gg.sets_-XPnSL` <- 
  ggvenn(
    ...
    stroke_alpha=1,
    auto_scale=FALSE) + 
  labs(title="733 Candidate Genes (-XP-nSL)", tag="(d)") + 
  theme(plot.caption=element_text(size=13, hjust=0.5), plot.title=element_text(size=15, hjust=0.5), plot.tag=element_text(size=15))
`gg.sets_-XPnSL`

ggsave(plot=`gg.sets_-XPnSL`, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.-XPnSL.png", bg="white", device=png, width=5, height=5, units="in", dpi=320)
ggsave(plot=`gg.sets_-XPnSL`, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.-XPnSL.pdf", bg="white", device=cairo_pdf, width=5, height=5, units="in")


unique(c(sets_both_XPnSL[[1]], sets_both_XPnSL[[2]], sets_both_XPnSL[[3]])) |> length()

str(sets_both_XPnSL)

gg.sets_both_XPnSL <- 
  ggvenn(
    data=sets_both_XPnSL, 
    digits=0,
    stroke_size=0.5, 
    set_name_size=4.5,
    text_size=4,
    ...
    stroke_alpha=1,
    auto_scale=FALSE) + 
  labs(title="767 Candidate Genes (XP-nSL)", tag="(d)") + 
  theme(plot.caption=element_text(size=13, hjust=0.5), plot.title=element_text(size=15, hjust=0.5), plot.tag=element_text(size=15))
gg.sets_both_XPnSL

ggsave(plot=gg.sets_both_XPnSL, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.+-XPnSL.png", bg="white", device=png, width=5, height=5, units="in", dpi=320)
ggsave(plot=gg.sets_both_XPnSL, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.+-XPnSL.pdf", bg="white", device=cairo_pdf, width=5, height=5, units="in")
...
gg.sets_XPCLR <- 
  ggvenn(
    ...
    stroke_alpha=1,
    auto_scale=FALSE) + 
  labs(title="564 Candidate Genes (XP-CLR)", tag="(d)") + 
  theme(plot.caption=element_text(size=13, hjust=0.5), plot.title=element_text(size=15, hjust=0.5), plot.tag=element_text(size=15))
gg.sets_XPCLR

ggsave(plot=gg.sets_XPCLR, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.XPCLR.png", bg="white", device=png, width=5, height=5, units="in", dpi=320)
ggsave(plot=gg.sets_XPCLR, filename="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/pairwise.venn.XPCLR.pdf", bg="white", device=cairo_pdf, width=5, height=5, units="in")
...
RegsNorteHumboldt |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/NorteHumboldt_SETS", col_names=FALSE)

RegsMendocino |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Mendocino_SETS", col_names=FALSE)

RegsSantaBarbara |> 
  select(gene_id, PANTHER_accession) |> 
  distinct() |>
  write_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/SantaBarbara_SETS", col_names=FALSE)
...
write_tsv(Regs, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Intersect.Candidate.Genes.tsv", na="")
...
write_tsv(Regs, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Intersect.Candidate.Genes.wide.tsv", na="")
...
saveRDS(object=dat0, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Candidate.Regions.RDS")
write_tsv(dat0, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Candidate.Regions.tsv")
...
write_tsv(Regs0, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Intersect.Candidate.Regions.tsv", na="")
...
write_tsv(Regs0, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Intersect.Candidate.Regions.wide.tsv", na="")

comboRegs <- full_join(x=Regs, y=Regs0) |> arrange(pop1, chr, start)

write_tsv(comboRegs, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Intersect.Candidate.Regions.Combo.wide.tsv", na="")
...
#write_tsv(candi, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Top.10.Candidate.Genes.tsv")


candi <- read_tsv(file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Top.10.Candidate.Genes.tsv")
saveRDS(object=candi, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Top.10.Candidate.Genes.RDS")
...
write_tsv(unesti, file="/Volumes/Tigrigobius/tgoby/genes/PANTHER.18.complete.redo/Top.10.Candidate.Genes.wide.tsv", na="")
